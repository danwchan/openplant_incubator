...
* **prototype_incubator_v2**
	...
	This folder contains the code for the upgraded incubator which heats and cools. Please consult the source code for inline comments describing it's operation.
